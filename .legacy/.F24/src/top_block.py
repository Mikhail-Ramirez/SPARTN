...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.channel_freq = channel_freq = 2.2e9
        self.center_freq = center_freq = 2.3e9
        ...
        self._channel_freq_range = qtgui.Range(2e9, 2.5e9, 0.1e6, 2.2e9, 200)
        ...
        self._audio_gain_range = qtgui.Range(0, 10, 0.1, 0, 200)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_1.set_frequency_range(self.channel_freq, self.samp_rate)
